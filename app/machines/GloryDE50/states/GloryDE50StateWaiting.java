 ...
 * @author adji
 */
public class GloryDE50StateWaiting extends MachineStateAbstract {

    public GloryDE50StateWaiting(MachineStateApiInterface machine) {
        super(machine);
    }
