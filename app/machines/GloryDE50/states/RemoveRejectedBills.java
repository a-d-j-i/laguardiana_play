 ...
 * @author adji
 */
public class RemoveRejectedBills extends MachineStateAbstract {

    final protected MachineStateInterface prevState;

    public RemoveRejectedBills(MachineStateInterface prevState, MachineStateApiInterface machine) {
        super(machine);
