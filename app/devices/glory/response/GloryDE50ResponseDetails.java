 ...
 * @author adji
 */
public class GloryDE50ResponseDetails implements Serializable {
    ...
    public GloryDE50ResponseDetails(GloryDE50Response r) {
        if (r == null) {
            return;
        }
        if (r instanceof GloryDE50ResponseWithData) {
