...
static unsigned char curr_counter_removed_bits = 0;
static unsigned char counter_removed_cnt = 0;
static unsigned long door_sol_switch = 0;
    ...
    if (INTCONbits.INT0IF && INTCONbits.INT0IE) {
        ...
        if (curr_counter_removed_bits != counter_removed_bits) {
            if (counter_removed_cnt < 150) {
                ...
                counter_removed_bits = curr_counter_removed_bits;
            }
        } else {
            counter_removed_cnt = 0;
        }
