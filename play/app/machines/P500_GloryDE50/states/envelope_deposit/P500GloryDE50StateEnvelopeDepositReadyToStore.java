...
public class P500GloryDE50StateEnvelopeDepositReadyToStore extends P500GloryDE50StateEnvelopeDepositStart {
    ...
    public P500GloryDE50StateEnvelopeDepositReadyToStore(P500GloryDE50StateEnvelopeDepositContext context) {
        super(context);
    }

    @Override
    public MachineEnvelopeDepositStatus getStatus() {
        return new MachineEnvelopeDepositStatus(context.getDepositId(), context.getCurrentUserId(), "EnvelopeDepositControler.mainloop", "READY_TO_STORE");
    }
...
//    }
    ...
    public String toString() {
        return "P500GloryDE50StateEnvelopeDepositReadyToStore{" + "context=" + context.toString() + '}';
    }
}
